...
export const SocialLoginButtons: React.FC<SocialLoginButtonsProps> = ({
  ...
  const getSizeClasses = () => {
    switch (size) {
      case 'small': return 'social-button--small';
      case 'large': return 'social-button--large';
      default: return 'social-button--medium';
    }
  };

  const getVariantClasses = () => {
    switch (variant) {
      case 'contained': return 'social-button--contained';
      default: return 'social-button--outlined';
    }
  };
...
export const SocialButton: React.FC<SocialButtonProps> = ({
  ...
  return (
    ...
    >
      <span className='social-button__icon'>
        {loading ? (
          <div className='social-button__spinner' />
        ) : (
          provider.icon
        )}
      </span>
