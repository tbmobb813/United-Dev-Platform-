...
These packages and apps were part of the original UDP IDE project (v0.1). They
are preserved here for reference during the pivot to the cross-platform workflow
tool architecture.
