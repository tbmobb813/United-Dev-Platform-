#!/usr/bin/env node
// Manual-run assertion harness for console replace report. Moved out of
// `scripts/__tests__` so Jest won't attempt to execute the CommonJS script
// inside its ESM worker VMs.
